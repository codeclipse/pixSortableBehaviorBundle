    ...
    var DraggableTable = function(element) {
        ...
        element.find('tbody').sortable({
            ...
            'update': function(event, ui) {
                ...
                $document.trigger('codeclipseSortableBehaviorBundle.update', [event, ui]);
                ...
                $.ajax({
                    ...
                    'dataType': 'json',
                    'error': function(data) {
                        $document.trigger('codeclipseSortableBehaviorBundle.error', [data]);
                    },
                    'success': function(data) {
                        $document.trigger('codeclipseSortableBehaviorBundle.success', [data]);
                    },
                    'complete': function() {
                        $document.trigger('codeclipseSortableBehaviorBundle.complete');
                    }
                });
            }
        }).disableSelection();
